            ...
            `<div id="modalBox" class="modalContent">
                ...
                <div id="modalContent">
                    ...
                    <div class="controlContainer">
                        ...
                        <input type="text" class="styledTxtInput" id="newPostCaption" name="newPostCaption">
                    </div><br><br>

                    <div class="controlContainer">
                        <label for="newPostDescription">Description: </label>
                        <input type="text" class="styledTxtInput styledLongTextInput" id="newPostDescription" name="newPostDescription">
                    </div><br><br>
